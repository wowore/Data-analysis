...
class MainWindow(QMainWindow):
    def __init__(self, filename):
        ...
        # 设置窗口标题
        icon = QIcon()
        icon.addFile('icons/browser.png')
        self.setWindowIcon(icon)
        self.setWindowTitle('XBrowser')
        self.i = 1
        # 设置窗口大小900*600
        ...
        self.webview.load(QUrl(self.filename))
    ...
    def create_tab(self, webview):
        self.tab = QWidget()
        self.tabWidget.addTab(self.tab, f"Page{self.i}")
        self.i += 1
